...
/**
 * Thinking / reasoning block. Claude Code may replay these on later turns.
 * Copilot never generates them, so they are stripped on the way upstream.
 */
...
export interface AnthropicMessageRequest {
  ...
  /** System prompt. Claude Code sends this as an array of content blocks. */
